...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="images/ilar.png" alt="First slide" style="height: 850px">
        <div class="carousel-caption d-none d-md-block">
          <h1>Interstellar</h1>
          <h5>A group of explorers make use of a newly discovered wormhole</h5>
        </div>
      </div>

      <div class="carousel-item">
        <img class="d-block w-100" src="images/hc.png" alt="Second slide" style="height: 850px">
        <div class="carousel-caption d-none d-md-block">
          <h1>Human Centipede</h1>
          <h5>2009 Dutch body horror film written</h5>
        </div>
      </div>

      <div class="carousel-item">
        <img class="d-block w-100" src="images/ff8.png" alt="Third slide" style="height: 850px">
        <div class="carousel-caption d-none d-md-block">
          <h1>Fast and Furious 8</h1>
          <h5>Cars and Family </h5>
        </div>
      </div>
  ...
  <div class="container-fluid">
			<div class="row" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; padding: 0 0 20px 10px;">
				...
				<div class="col-sm-10">
					<img src="images/ilar.png" style="width: 500px; margin-left: 350px;">
					<p style="text-align: center; padding: 20px 0 0 0"><b>Interstellar, Sci-Fi</b></p>
          
          <img src="images/ff8.png" style="width: 500px; margin-left: 350px;">
					<p style="text-align: center; padding: 20px 0 0 0"><b>Fast and Furious, Action</b></p>

          <img src="images/hc.png" style="width: 500px; margin-left: 350px;">
					<p style="text-align: center; padding: 20px 0 0 0"><b>Human Centipede, Horror</b></p>
