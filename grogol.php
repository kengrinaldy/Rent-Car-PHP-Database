...
<body>
    ...
    <div class="container-fluid">
			<div class="row" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; padding: 0 0 20px 10px;">
				...
				<div class="col-sm-10">
					<p style="background-color:#00a8ff; border-radius: 10px; text-align: justify; padding: 20px 20px; margin-top: 10px;">Sebuah kecamatan yang berada di daerah jakarta barat, disini terdapat universitas top di jakarta. Yaitu ada Universitas Tarumanagara dan Universitas Trisakti.</p>
					<p style="text-align: center;"><b>Grogol Petamburan, Jakarta Barat</b></p>
					<p style="text-align: center;">Beberapa Tempat Terkenal dekat grogol petamburan, Jakbar</p>
					<p style="text-align: justify;"><b>1. Universitas Tarumanagara</b></p>
					<img src="images/untar.jpg" style="width: 600px; padding: 10px; margin-left: 300px; margin-bottom: 10px;">
					<p style="background-color:#00a8ff; border-radius: 10px; text-align: justify; text-align: justify; padding: 20px;">Universitas Tarumanagara adalah salah satu universitas swasta tertua yang berada di Jakarta, Indonesia. Nama universitas ini berasal dari nama kerajaan Tarumanagara. Universitas ini berdiri pada tanggal 1 Oktober 1959 dengan ditandai berdirinya "Perguruan Tinggi Ekonomi Tarumanagara" di bawah naungan "Yayasan Tarumanagara" yang berdiri pada tanggal 18 Juni 1959.</p>

					<p style="text-align: justify;"><b>2. Universitas Trisakti</b></p>
					<img src="images/skti.jpg" style="width: 600px; padding: 10px; margin-left: 300px; margin-bottom: 10px;">
					<p style="background-color:#00a8ff; border-radius: 10px; text-align: justify; text-align: justify; padding: 20px;">Universitas Trisakti merupakan salah satu perguruan tinggi swasta di Indonesia. Perguruan tinggi ini didirikan oleh Pemerintah Republik Indonesia pada tanggal 29 November 1965 melalui Surat Keputusan Menteri PTIP Nomor 013/da/1965 yang ditandatangani oleh Dr. Sjarif Thajeb. Tanggal 29 November ini kemudian ditetapkan sebagai hari kelahiran Universitas Trisakti. Universitas Trisakti terletak di Jalan Kyai Tapa, Grogol Petamburan, Jakarta Barat. Posisi kampus Universitas Trisakti strategis karena berada di pusat kota Jakarta yang merupakan pusat pemerintahan, kegiatan bisnis, perekonomian dan politik nasional.</p>
                    
                    <p style="background-color: black; color: white; border-radius: 10px; text-align: center;"><b>Tempat Nongkrong sekitar sini</b></p>
                    <img src="images/alfax.jpg" style="width: 600px; padding: 10px; margin-bottom: 10px;">
                    <img src="images/mcipu.jpg" style="width: 600px; padding: 10px; margin-bottom: 10px;">
                    <p style="float: left; background-color: black; margin-left: 250px; color: white; border-radius: 10px;"><b>Alfa X</b></p>
                    <p style="float: left; background-color: black; margin-left: 590px; color: white; border-radius: 10px;"><b>Mal Ciputra</b></p>
