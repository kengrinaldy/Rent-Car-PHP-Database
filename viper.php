...
<body>
  ...
  <div class="container-fluid">
			<div class="row" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; padding: 0 0 20px 10px;">
				...
				<div class="col-sm-10">
					<img src="images/Viper5.jpg" style="width: 100%">
					<p style="text-align: center; padding: 20px 0 0 0"><b>Dodge Viper</b></p>
					<p style="text-align: center;">Mobil muscle berkekuatan dan kecepatan yang tinggi</p>
					<p style="background-color:#00a8ff; border-radius: 10px; text-align: justify;  padding: 20px;">Sebagai prime mobil yang ada di game-game jadul ps2 seperti Need For Speed yang membuat mobil ini jadi keren pada masanya dan membuat saya jatuh cinta pada pandangan pertama</p>
					<p style="background-color: red; color: white; border-radius: 10px; text-align: center;  padding: 20px;"><b>Spesifikasi Dodge Viper</b></p>
					<p style="background-color:#00a8ff; border-radius: 10px; text-align: justify;  padding: 20px;">1. Dari bonet yang hampir separuh ukuran bodi, tersimpan sebongkah mesin 10 silinder berbahan aluminium berkapasitas 8.4-liter. Mesin ini dipercaya sanggup memproduksi tenaga 645 hp dengan torsi puncak hingga 814 Nm. </p>
					<p style="background-color:#00a8ff; border-radius: 10px; text-align: justify;  padding: 20px;">2. Dodge Viper SRT memiliki pengendalian yang luar baisa baik berkat penggunaan suspensi independent high-performace yang dipadukan shock absorber Bilstein. Pengemudi juga dapat memilih two-mode suspension yakni Street atau Track. Fitur lain seperti Launch Control dan 5-mode Electronic Stability Control juga mampu menjaga saluran tenaga tak terbuang percuma pada keempat rodanya.</p>
				</div>
				<div class="col-sm-1"></div>
			</div>
		</div>
