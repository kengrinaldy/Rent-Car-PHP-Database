...
<?php
  ...
  if(isset($_POST['Simpan'])) {
	...
	if (empty($nama)) {
		mysqli_query($connection, "INSERT INTO movie VALUES ('$movieID', '$namamovie', '$genremovie', 'no_images.png')");
		...
		if(($ekstensiFile == "png") or ($ekstensiFile == "PNG")) {
			...
			mysqli_query($connection, "INSERT INTO movie VALUES ('$movieID', '$namamovie', '$genremovie', '$nama')");
			header("location:movie.php");
		}
	}
  }
