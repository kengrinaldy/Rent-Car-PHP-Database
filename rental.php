...
<?php
  ...
  if(isset($_POST['Simpan'])) {
  	...
  	mysqli_query($connection, "INSERT INTO rentalmobil VALUES ('$platKode', '$merkMobil', '$typeMobil', '$kodeArea')");
	...
	<div class="row">
	    ...
	    <div class="col-sm-10">
	    	<div class="jumbotron jumbotron-fluid">
				<div class="container">
					<h1 class="display-4">Input Rental Mobil</h1>
				</div>
	      	...
	      	<form method="POST">
	        	<div class="form-group row">
	          		...
	          		<div class="col-sm-10">
	            		<input type="text" class="form-control" id="kodeMobil" name="inputKode" placeholder="Plat Nomor" maxlength="9">
	          		</div>
	        	</div>
		        ...
		        <div class="form-group row">
		          	...
		          	<div class="col-sm-10">
		            	<input type="text" class="form-control" id="merkMobil" name="inputMerk" placeholder="Merk Mobil" maxlength="35">
		          	</div>
		        </div>

		        <div class="form-group row">
		          	<label for="typeMobil" class="col-sm-2 col-form-label">Tipe Mobil</label>
		         	<div class="col-sm-10">
		            	<input type="text" class="form-control" id="typeMobil" name="inputType" placeholder="Tipe Mobil" maxlength="35">
		          	</div>
		        </div>
		...
		<div class="col-sm-10">
			...
			<form method="POST">
				<div class="form-group row mb-2">
					<label for="search" class="col-sm-3">Tipe Mobil</label>
					<div class="col-sm-6">
						<input type="text" name="search" class="form-control" id="search" value="<?php if (isset($_POST['search'])) {echo $_POST['search'];} ?>" placeholder="Cari Tipe Mobil">
					</div>
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td>
								<a href="rentalEdit.php?ubah=<?php echo $row['platID']?>"
