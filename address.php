...
<body>
  ...
  <div class="container-fluid">
			<div class="row" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; padding: 0 0 20px 10px;">
				...
				<div class="col-sm-10">
					<img src="images/lmanado.png" style="width: 500px; margin-left: 350px;">
					<p style="text-align: center; padding: 20px 0 0 0"><b>Manado, Kota Manado</b></p>
          
          <img src="images/lpapua.png" style="width: 500px; margin-left: 350px;">
					<p style="text-align: center; padding: 20px 0 0 0"><b>Papua, Kota Jayapura</b></p>

          <img src="images/ljakarta.png" style="width: 500px; margin-left: 350px;">
					<p style="text-align: center; padding: 20px 0 0 0"><b>	DKI Jakarta, Jakarta Barat</b></p>
