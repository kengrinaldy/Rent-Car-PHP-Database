...
<html lang="en">
    ...
    <div class="card shadow mb-4">
     ...
     <?php 
        ...
        if(isset($_POST['ubahkabupaten']))
        {
            ...
            $kabupatenALAMAT = $_POST['inputaltkabupaten'];
            $kabupatenKET = $_POST['inputketkabupaten'];
            $kabupatenFOTOICONKET = $_POST['inputfotoketkabupaten'];

            $nama = $_FILES['filekbp']['name'];
            $file_tmp = $_FILES["filekbp"]["tmp_name"];
            ...
            //PERIKSA EXTENSI FILE HARUS JPG AAU jpg
            /*IF(($ekstensifile == "jpg")or ($ekstensifile == "JPG"))
            { */
                move_uploaded_file($file_tmp, 'img/'.$nama); //unggah file ke folder img
                mysqli_query($connection, "UPDATE kabupaten SET kabupatenNAMA='$kabupatenNAMA', kabupatenALAMAT='$kabupatenALAMAT', kabupatenFOTOICON='$nama',
                kabupatenKET='$kabupatenKET', kabupatenFOTOICONKET='$kabupatenFOTOICONKET'
                    WHERE kabupatenKODE='$kabupatenKODE'");
                header("location:kabupaten.php");
           /* } */
    ...
    <div class="col-sm-10">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kabupatenKODE" name="inputkodekabupaten" value="<?php echo $rowedit["kabupatenKODE"] ?>" readonly>
                </div>
            </div> 
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kabupatenNAMA" name="inputnamakabupaten" value="<?php echo $rowedit["kabupatenNAMA"] ?>" >
                </div>
            </div>
            <div class="form-group row">
                <label for="kabupatenALAMAT" class="col-sm-2 col-form-label">Alamat Kabupaten</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kabupatenALAMAT" name="inputaltkabupaten" value="<?php echo $rowedit["kabupatenALAMAT"] ?>" >
                </div>
            </div>
            <div class="form-group row">
                <label for="kabupatenKET" class="col-sm-2 col-form-label">Keterangan Kabupaten</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kabupatenKET" name="inputketkabupaten" value="<?php echo $rowedit["kabupatenKET"] ?>" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="file" id="file" name="filekbp">
            ...
            <div class="form-group row">
                <label for="kabupatenFOTOICONKET" class="col-sm-2 col-form-label">Keterangan Icon Kabupaten</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kabupatenFOTOICONKET" name="inputfotoketkabupaten" value="<?php echo $rowedit["kabupatenFOTOICONKET"] ?>" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="submit" name="ubahkabupaten" class="btn btn-primary" value="Ubah">
                    <input type="submit" name="Batal" class="btn btn-primary" value="Batal">
                </div>
            </div>
        </form>
                ...
                { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            {?>
                            <img src="img/<?php echo $row['kabupatenFOTOICON']?>" width="88" >
                        ...
                        <td>
                        <a href="kabupatenedit.php?ubahkabupaten=<?php echo $row['kabupatenKODE']?>" class="btn btn-succes btn-sm" title="EDIT">
    ...
    <script type="text/javascript" src="https://ajax.googleapis.com/ajac/libs/jquery/2.1.1/jquery.min.js"></script>
