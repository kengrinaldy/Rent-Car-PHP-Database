<?php 
    ...
    if(isset($_GET['hapusfoto'])){
        ...
        $hapusfoto = mysqli_query($connection, "SELECT * FROM fotodestinasi WHERE fotoID = '$fotokode'");
        ...
        echo "<script>alert('DATA TELAH DIHAPUS'); document.location='photodestinasi.php'</script>";
    }
?>